...
function c2xa_generate( object_layer )
    ...
    local enemy_pattern600 = {
        ...
        goal   = cc.p( 610, 500 ),
        duration = 15,
        fire = { 3, bullet_player, 3, bullet_player, 3, bullet_player },
    }
    local enemy_pattern700 = {
        update = moving.homing,
        start  = cc.p( -50, 600 ),
        goal   = cc.p( 610, 500 ),
        duration = 5,
        fire = { 1, bullet_player_high, 1, bullet_player_high, 0.5, bullet_player_high },
    }
    local enemy_pattern800 = {
        update = moving.homing,
        start  = cc.p( -50, 600 ),
        goal   = cc.p( 610, 600 ),
        duration = 3,
    ...
    local enemy_pattern900 = {
        update = moving.homing,
        start  = cc.p( -50, 500 ),
        goal   = cc.p( 610, 700 ),
        duration = 5,
        fire = { 1, bullet_player_high, 1, bullet_player_high, 0.5, bullet_player_high, 0.5, bullet_player_high, 1, bullet_player_high, 1, bullet_player_high },
    }
    local enemy_pattern910 = {
        update = moving.homing,
        start  = cc.p( 610, 500 ),
        goal   = cc.p( -50, 700 ),
        duration = 5,
    ...
    local enemy_pattern920 = {
        update = moving.wait_once,
        start  = cc.p( 610, 600 ),
        goal   = cc.p( -50, 600 ),
        duration = 5,
        fire = { 1, bullet_player_high, 1, bullet_player_high, 0.5, bullet_player_high, 0.5, bullet_player_high, 1, bullet_player_high },
    }
    -------------- 
    ...
    object_layer:runAction(
        action.sequence({
            ...
            action.create_enemy( enemy_pattern800 ),
            action.wait( 0.5 ),
            action.create_enemy( enemy_pattern800 ),
            action.wait( 0.5 ),
            action.create_enemy( enemy_pattern800 ),
            ...
            action.create_enemy( enemy_pattern700 ),
            action.create_enemy( enemy_pattern500 ),
            action.wait( 2 ),
            action.create_enemy( enemy_pattern700 ),
            action.wait( 2 ),
            ...
            action.create_enemy( enemy_pattern700 ),
            action.create_enemy( enemy_pattern910 ),
            action.wait( 2 ),
            action.create_enemy( enemy_pattern700 ),
            action.create_enemy( enemy_pattern910 ),
            action.wait( 2 ),
            ...
            action.wait( 2 ),
            action.create_enemy( enemy_pattern700 ),
            action.create_enemy( enemy_pattern900 ),
            action.wait( 2 ),
            action.create_enemy( enemy_pattern900 ),
            action.create_enemy( enemy_pattern500 ),
            action.wait( 4 ),
